...
// const fetchClientData = async (clientId: string): Promise<PerformanceData[]> => {
//   const response = await fetch(`/api/performance?client_id=${clientId}`);
//   return response.json();
// };

// Generate client-specific data
const generateClientData = (clientId: string): PerformanceData[] => {
...
export function usePerformanceData(selectedClient: string = 'all', showAll: boolean = false) {
